...
void explode(int index, vec3 movement) {
    ...
    fragPosWorldSpace = gs_in[index].fragPosWorldSpace;
    fragPosDirLightSpace = gs_in[index].fragPosDirLightSpace;
    fragPosSpotLightSpace = gs_in[index].fragPosSpotLightSpace;
